...
public class LojaMenu {
    ...
    static Scanner sc1;
    static Loja loja;
    static ListaProdutos carrinho;
    static ListaProdutos desejos;


    public static void main(String[] args) {
        sc1 = new Scanner(System.in);
        loja = new Loja();
        carrinho = new Carrinho(12);
        desejos = new ListaDesejos(5);
    ...
    static public void finalizarPedido(){
        ...
        Cliente cli = new Cliente(cpf, nome, endereco, cep, email, 1);

        ListaProdutos carrinhoTemp = carrinho;
        Pedido pedido = new Pedido( cli , carrinhoTemp );
    ...
    static public void menuDepartamento(Produto.departamento dep){
        int op;
        do {
            System.out.println("Produtos de" + dep);
            System.out.println(loja.listaPorDepartamento(dep));
            System.out.println("[30] - Retornar ao menu anterior");
    ...
    static public void menuProduto( int indexProd){
        ...
        do {
            ...
            switch (op){
                case 1:
                    b = carrinho.addProduto(loja.produtos[indexProd]);
                    if (b){
                    ...
                    break;
                case 2:
                    b = desejos.addProduto(loja.produtos[indexProd]);
                    if (b){
    ...
    static public void menuDesejos(){
        ...
        do {
            ...
            System.out.println(desejos.listarProdutos());
            System.out.println("--------------------");
